...
export default function Experiences({ setActiveSection }) {
    ...
    useEffect(() => {
        const observer = new IntersectionObserver(
            ([entry]) => {
                entry.isIntersecting ? setActiveSection("Experience") : null;
            },
            { threshold: 0.3 }
        );
    ...
    const experiences = [
        {
            ...
            company_name: "Lead Generation & Outreach Platform",
        ...
        },
        {
            ...
            company_name: "B2B Manufacturer Sourcing Platform",
        ...
        },
        {
            ...
            position: "Full-Stack Developer",
            company_name: "Data Collection & Automation System",
        ...
        },
        {
            ...
            position: "Backend Developer",
            company_name: "Web Application Backend",
        ...
        },
        {
            ...
            company_name: "Product & Business Websites",
        ...
        },
        {
            date: "Jul 2023",
            position: "Frontend Developer",
            company_name: "Authentication UI",
    ...
    return (
        <section id="Experience" ref={sectionRef}>
            ...
            <h1 className="section-title">Client Work</h1>
