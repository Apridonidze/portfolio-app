export default function Experience({ setActiveSection }){
    ...
    const experiences = [
        ...
        },
        {
            ...
            description:
            "Contributed as a backend developer on a dynamic event management platform, catering to administrators and event organizers. Facilitated seamless registration, event creation, and management through an admin panel. Improved codebase quality by reviewing, optimizing, and extending AI-assisted backend, ensuring a secure and maintainable system. Integrated with third-party ticketing sites for data synchronization, enhancing information reliability across multiple platforms.",
            responsibilities: [
